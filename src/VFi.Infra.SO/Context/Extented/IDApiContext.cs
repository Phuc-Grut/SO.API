...
public class IDApiContext
{
    private readonly IFlurlClient _flurlClient;
    private readonly IConfiguration _appConfig;

    public IDApiContext(IConfiguration configuration, IFlurlClientFactory flurlClientFac)
    {
    ...
    private EndpointApiConfig Endpoint
    {
        get
        {
            return _appConfig.GetSection("EndPointApi:ID").Get<EndpointApiConfig>();
        }
    }
