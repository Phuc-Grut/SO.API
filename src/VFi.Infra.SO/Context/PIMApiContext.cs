...
public class PIMApiContext
{
    private readonly IFlurlClient _flurlClient;
    private readonly IConfiguration appConfig;

    public PIMApiContext(IConfiguration configuration, IFlurlClientFactory flurlClientFac)
    {
    ...
    private EndpointApiConfig Endpoint
    {
        get
        {
            return appConfig.GetSection("EndPointApi:PIM").Get<EndpointApiConfig>();
        }
    }
