...
public class AddRptTinhHinhThucHienDonBanHangHandler : INotificationHandler<AddRptTinhHinhThucHienDonBanHangEvent>
{
    ...
    public AddRptTinhHinhThucHienDonBanHangHandler(IEventRepository eventRepository)
    {
        this.eventRepository = eventRepository;
    }

    public async Task Handle(AddRptTinhHinhThucHienDonBanHangEvent notification, CancellationToken cancellationToken)
    {

        var message = new VFi.Domain.SO.Events.AddRptTinhHinhThucHienDonBanHangQueueEvent();
        ...
        var result = await eventRepository.AddRptTinhHinhThucHienDonBanHang(message);
