...
public class AddRptTinhHinhThucHienHopDongBanHandler : INotificationHandler<AddRptTinhHinhThucHienHopDongBanEvent>
{
    ...
    public AddRptTinhHinhThucHienHopDongBanHandler(IEventRepository eventRepository)
    {
        this.eventRepository = eventRepository;
    }

    public async Task Handle(AddRptTinhHinhThucHienHopDongBanEvent notification, CancellationToken cancellationToken)
    {

        var message = new VFi.Domain.SO.Events.AddRptTinhHinhThucHienHopDongBanQueueEvent();
        ...
        var result = await eventRepository.AddRptTinhHinhThucHienHopDongBan(message);
