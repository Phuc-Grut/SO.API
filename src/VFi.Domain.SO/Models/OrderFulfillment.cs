...
{
    public partial class OrderFulfillment : Entity, IAggregateRoot
    {
        public OrderFulfillment()
        {
            OrderFulfillmentDetail = new HashSet<OrderFulfillmentDetail>();
        }
        ...
        public  ICollection<OrderFulfillmentDetail> OrderFulfillmentDetail { get; set; }
    }
}