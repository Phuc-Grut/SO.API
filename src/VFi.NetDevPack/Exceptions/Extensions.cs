...
public static class Extensions
{
    ...
    public static (IQueryable<T>, int, IQueryable<T>) ApplyFopOutput<T>(this IQueryable<T> source, IFopRequest request)
    {
        int totalRowsAfterFiltering = source.Count();
        ...
        return (source, totalRowsAfterFiltering, output);
    }
