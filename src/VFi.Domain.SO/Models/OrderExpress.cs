...
{
    public partial class OrderExpress : Entity, IAggregateRoot
    {
        public OrderExpress()
        {
            OrderExpressDetail = new HashSet<OrderExpressDetail>();
        ...
        public  ICollection<OrderExpressDetail> OrderExpressDetail { get; set; }
