...
public class AddRptTongHopBanHangTheoKhachHangHandler : INotificationHandler<AddRptTongHopBanHangTheoKhachHangEvent>
{
    ...
    public AddRptTongHopBanHangTheoKhachHangHandler(IEventRepository eventRepository)
    {
        this.eventRepository = eventRepository;
    }

    public async Task Handle(AddRptTongHopBanHangTheoKhachHangEvent notification, CancellationToken cancellationToken)
    {

        var message = new VFi.Domain.SO.Events.AddRptTongHopBanHangTheoKhachHangQueueEvent();
        ...
        var result = await eventRepository.AddRptTongHopBanHangTheoKhachHang(message);
