...
{
    public partial class PaymentTermConfiguration : IEntityTypeConfiguration<PaymentTerm>
    {
        public void Configure(EntityTypeBuilder<PaymentTerm> entity)
        {
            entity.ToTable("PaymentTerm", "so");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<PaymentTerm> entity);
    }
}
