...
{
    public partial class CustomerGroupConfiguration : IEntityTypeConfiguration<CustomerGroup>
    {
        public void Configure(EntityTypeBuilder<CustomerGroup> entity)
        {
            entity.ToTable("CustomerGroup", "so");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<CustomerGroup> entity);
    }
}
