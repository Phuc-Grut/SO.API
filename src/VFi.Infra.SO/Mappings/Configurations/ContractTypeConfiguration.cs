...
{
    public partial class ContractTypeConfiguration : IEntityTypeConfiguration<ContractType>
    {
        public void Configure(EntityTypeBuilder<ContractType> entity)
        {
            entity.ToTable("ContractType", "so");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<ContractType> entity);
    }
}
