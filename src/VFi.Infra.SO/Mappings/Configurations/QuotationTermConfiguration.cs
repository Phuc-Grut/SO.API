...
{
    public partial class QuotationTermConfiguration : IEntityTypeConfiguration<QuotationTerm>
    {
        public void Configure(EntityTypeBuilder<QuotationTerm> entity)
        {
            entity.ToTable("QuotationTerm", "so");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<QuotationTerm> entity);
    }
}
